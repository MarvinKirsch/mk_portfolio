"""
Django settings for mk_portfolio project.
...
ROOT_URLCONF = 'mk_portfolio.urls'
...
WSGI_APPLICATION = 'mk_portfolio.wsgi.application'
ASGI_APPLICATION = 'mk_portfolio.asgi.application'
